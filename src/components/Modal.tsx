            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <DialogPanel
                 ...
                 sm:w-full sm:max-w-2xl sm:p-6 bg-white/60 backdrop-blur-sm"
                >
                  <DialogTitle
                    as="h3"
                  ...
                  <p className="text-lg bg-white/40 backdrop-blur-sm p-5 rounded-3xl shadow-lg">
                    {selectedRecipe.strInstructions}
                  </p>
                  <p
                    className="text-xl text-center p-1 bg-orange-400 mt-4 rounded-xl
